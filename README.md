...
This Dockerfile uses an [expect](https://linux.die.net/man/1/expect) script to automatically fill the interactive installer prompts. The [expect.exp](expect.exp) file needs to be edited to fill in
